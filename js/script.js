...
function showHideContent(){
	if (jQuery('body').hasClass('standard')){
		if (jQuery('.standard .header_wrap').css('left') == '10px'){
			jQuery('.standard .header_wrap').animate({left:'-265px'}, 700, 'easeInQuint', function(){
				jQuery('.standard .header_arrow').addClass('hidden').css({left:'85px'}).animate({left:'175px'}, 300, 'easeInQuint');
			});
			...
			jQuery('.standard .header_arrow').animate({left:'85px'}, 300, 'easeOutQuint', function(){
				...
				jQuery('.standard #middle').animate({left:'282px'}, 700, 'easeOutQuint', function(){
